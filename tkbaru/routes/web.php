...
Route::group(['prefix' => LaravelLocalization::setLocale()], function ()
{
    ...
    Route::get('/dashboard/master/truck/maintenance/show/{id}', 'TruckMaintenanceController@show')->name('db.master.truck.maintenance.show');
    Route::get('/dashboard/master/truck/maintenance/create', 'TruckMaintenanceController@create');
    Route::post('/dashboard/master/truck/maintenance/create', 'TruckMaintenanceController@store')->name('db.master.truck.maintenance.create');
    Route::get('/dashboard/master/truck/maintenance/edit/{id}', 'TruckMaintenanceController@edit')->name('db.master.truck.maintenance.edit');
