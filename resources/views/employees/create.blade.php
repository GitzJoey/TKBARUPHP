...
@section('title')
    @lang('employees.create.title')
@endsection

@section('page_title')
    <span class="fa fa-employees fa-flip-horizontal fa-fw"></span>&nbsp;@lang('employees.create.page_title')
@endsection

@section('page_title_desc')
    @lang('employees.create.page_title_desc')
@endsection
                ...
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input id="inputName" name="name" type="text" class="form-control"
                               placeholder="@lang('employees.field.name')" data-parsley-required="true">
                ...
                <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input id="inputEmail" name="email" type="text" class="form-control"
                               placeholder="@lang('employees.field.email')" data-parsley-required="true">
                ...
                <div class="form-group {{ $errors->has('ic_number') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input id="inputIcNumber" name="ic_number" type="text" class="form-control"
                               placeholder="@lang('employees.field.ic_number')" data-parsley-required="true">
                        <span class="help-block">{{ $errors->has('ic_number') ? $errors->first('ic_number') : '' }}</span>
                    </div>
                </div>
                <div class="form-group {{ $errors->has('image_path') ? 'has-error' : '' }}">
                    <label for="inputFoto" class="col-sm-2 control-label">@lang('employees.field.image_path')</label>
                    <div class="col-sm-10">
                        <input id="inputImagePath" name="image_path" type="file" class="form-control"
                               placeholder="@lang('employees.field.image_path')" data-parsley-required="true">
