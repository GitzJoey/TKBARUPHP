...
@section('title')
    @lang('tax.invoice.input.create.page_title')
@endsection

@section('page_title')
    <span class="fa fa-sign-out"></span>&nbsp;@lang('tax.invoice.input.create.page_title')
@endsection

@section('page_title_desc')
    @lang('tax.invoice.input.create.page_title_desc')
@endsection
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" name="is_creditable" id="is_creditable" value="1" checked>
                                            @lang('tax.invoice.input.create.misc.yes')
                                        </label>
                                    </div>
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" name="is_creditable" id="is_creditable" value="0">
