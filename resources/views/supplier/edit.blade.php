...
@section('page_title')
    <span class="fa fa-smile-o fa-fw"></span>&nbsp;@lang('supplier.edit.page_title')
@endsection
                    ...
                    <div class="col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li><a href="#tab_customer" data-toggle="tab">@lang('supplier.edit.tab.customer')</a></li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_customer">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="inputName" name="name" type="text" class="form-control" value="{{ $customer->name }}" placeholder="@lang('supplier.field.name')">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="inputCity" name="city" type="text" class="form-control" value="{{ $customer->city }}" placeholder="@lang('supplier.field.city')">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPhone" class="col-sm-2 control-label">@lang('supplier.field.phone')</label>
                                        <div class="col-sm-10">
                                            <input id="inputPhone" name="phone" type="tel" class="form-control" value="{{ $customer->phone }}" placeholder="@lang('supplier.field.phone')">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputTaxId" class="col-sm-2 control-label">@lang('supplier.field.tax_id')</label>
                                        <div class="col-sm-10">
                                            <input id="inputTaxId" name="tax_id" type="text" class="form-control" value="{{ $customer->tax_id }}" placeholder="@lang('supplier.field.tax_id')">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputRemarks" class="col-sm-2 control-label">@lang('supplier.field.remarks')</label>
                                        <div class="col-sm-10">
                                            <input id="inputRemarks" name="remarks" type="text" class="form-control" value="{{ $customer->remarks }}" placeholder="@lang('supplier.field.remarks')">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-group" id="accordion_bankaccount">
                                            ...
                                            <div class="box-header with-border">
                                                <h4 class="box-title">
                                                    <a class="collapsed" aria-expanded="false" href="#collapseBankAccountLists" data-toggle="collapse" data-parent="#accordion_bankaccount">
                                                        @lang('supplier.edit.tab.header.bank_lists')
                                                    </a>
                                                </h4>
                                            </div>
                                        ...
                                        <div class="panel box box-default">
                                            <div class="box-header with-border">
                                                <h4 class="box-title">
                                                    <a class="collapsed" aria-expanded="false" href="#collapseBankAccountInputs" data-toggle="collapse" data-parent="#accordion_bankaccount">
                                                        @lang('supplier.edit.tab.header.bank_inputs')
                                                    </a>
                                                </h4>
                                            </div>
                                            <div class="panel-collapse collapse" id="collapseBankAccountInputs" aria-expanded="false">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="inputBank" class="col-sm-2 control-label">@lang('supplier.field.bank')</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputBankAccount" class="col-sm-2 control-label">@lang('supplier.field.bank_account')</label>
                                                        <div class="col-sm-10">
                                                            <input id="inputBankAccount" type="text" class="form-control" ng-model="inputBank.bank_account" placeholder="@lang('supplier.field.bank_account')">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputRemarks" class="col-sm-2 control-label">@lang('supplier.field.remarks')</label>
                                                        <div class="col-sm-10">
                                                            <input id="inputRemarks" type="text" class="form-control" ng-model="inputBank.remarks" placeholder="@lang('supplier.field.remarks')">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
