                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="paymentHistoryTable" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th width="25%"
                                            class="text-center">@lang('purchase_order.payment.transfer.table.payments.header.payment_type')</th>
                                        <th width="25%"
                                            class="text-center">@lang('purchase_order.payment.transfer.table.payments.header.payment_date')</th>
                                        <th width="25%"
                                            class="text-center">@lang('purchase_order.payment.transfer.table.payments.header.payment_status')</th>
                                        <th width="25%"
                                            class="text-center">@lang('purchase_order.payment.transfer.table.payments.header.payment_amount')</th>
                                    </tr>
                                    </thead>
                                    <tbody>
