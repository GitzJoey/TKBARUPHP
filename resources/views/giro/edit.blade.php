        ...
        {!! Form::model($giro, ['method' => 'PATCH', 'route' => ['db.bank.giro.edit', $giro->hId()], 'class' => 'form-horizontal', 'data-parsley-validate' => 'parsley']) !!}
            <div class="box-body">
                ...
                <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input id="inputAmount" name="amount" type="text" class="form-control" value="{{ $giro->amount }}" placeholder="@lang('giro.field.amount')" data-parsley-required="true" data-parsley-type="number">
