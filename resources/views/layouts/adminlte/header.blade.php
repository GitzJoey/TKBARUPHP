            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{ Auth::user()->getStore->name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{ asset('images/blank.png') }}" class="img-circle" alt="User Image">
                            <p>
                                {{ Auth::user()->getStore->name }}
                                <small>{{ Auth::user()->getStore->address }}</small><br/>
                                <small>{{ Auth::user()->getStore->tax_id }}</small>
                            </p>
                        </li>
                        <li class="user-body">
                            <div class="row">
