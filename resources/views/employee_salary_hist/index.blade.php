...
@section('content')
    ...
    <div class="box box-info">
        ...
        <div class="box-footer clearfix">
            <a class="btn btn-success" href="{{ route('db.employee.employee_salary.calculate_salary') }}"><span class="fa fa-plus fa-fw"></span>&nbsp;@lang('buttons.calculate_salary') ({{ date('M').' '.date('Y') }})</a>
            {!! $employeelist->render() !!}
        </div>
    </div>
@endsection