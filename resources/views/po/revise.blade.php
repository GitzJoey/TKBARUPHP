...
@section('title')
    @lang('po.revise.title')
@endsection

@section('page_title')
    <span class="fa fa-truck fa-fw"></span>&nbsp;@lang('po.revise.page_title')
@endsection
@section('page_title_desc')
    @lang('po.revise.page_title_desc')
@endsection

@section('content')
    <form class="form-horizontal" action="{{ route('db.po.revise') }}" method="post">
        <div class="row">
            <div class="col-md-7">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('po.revise.box.supplier')</h3>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-md-5">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('po.revise.box.purchase_order_detail')</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('po.revise.box.shipping')</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <label for="inputShippingDate" class="col-sm-3 control-label">@lang('po.revise.field.shipping_date')</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="inputShippingDate" name="shipping_date" placeholder="Shipping Date">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputWarehouse" class="col-sm-3 control-label">@lang('po.revise.field.warehouse')</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="inputWarehouse" name="wareohouse" placeholder="Warehouse">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputVendorTrucking" class="col-sm-3 control-label">@lang('po.revise.field.vendor_trucking')</label>
                            <div class="col-sm-9">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('po.revise.box.transactions')</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="itemsListTable" class="table table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th width="30%">@lang('po.revise.table.item.header.product_name')</th>
                                        <th width="15%">@lang('po.revise.table.item.header.header.quantity')</th>
                                        <th width="15%" class="text-right">@lang('po.revise.table.item.header.unit')</th>
                                        <th width="15%" class="text-right">@lang('po.revise.table.item.header.price_unit')</th>
                                        <th width="5%">&nbsp;</th>
                                        <th width="20%" class="text-right">@lang('po.revise.table.item.header.total_price')</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="itemsTotalListTable" class="table table-bordered">
                                    <tbody>
                                    <tr>
                                        <td width="80%" class="text-right">@lang('po.revise.table.total.body.total')</td>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('po.revise.box.remarks')</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
