            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="inputIncVal" name="increment_value" type="text" class="form-control" value="{{ old('increment_value') }}" placeholder="Increment Value">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPctVal" class="col-sm-2 control-label">@lang('price_level.field.pctval')</label>
                        <div class="col-sm-10">
                            <input id="inputPctVal" name="percentage_value" type="text" class="form-control" value="{{ old('percentage_value') }}" placeholder="Percentage Value">
                        </div>
                    </div>
