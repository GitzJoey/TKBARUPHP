...
@section('title')
    @lang('accounting.cash_flow.edit.title')
@endsection

@section('page_title')
    <span class="fa fa-circle-o fa-fw"></span>&nbsp;@lang('accounting.cash_flow.edit.page_title')
@endsection

@section('page_title_desc')
    @lang('accounting.cash_flow.edit.page_title_desc')
@endsection
...
@section('content')
    ...
    <div class="box box-info">
        ...
        {!! Form::model($cashflow, ['method' => 'PATCH', 'route' => ['db.acc.cash_flow.edit', $cashflow->hId()], 'class' => 'form-horizontal', 'data-parsley-validate' => 'parsley']) !!}
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <a href="{{ route('db.acc.cash_flow') }}" class="btn btn-default">@lang('buttons.cancel_button')</a>
