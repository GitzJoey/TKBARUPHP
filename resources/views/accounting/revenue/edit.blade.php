...
@section('title')
    @lang('accounting.revenue.edit.title')
@endsection

@section('page_title')
    <span class="fa fa-circle-o fa-fw"></span>&nbsp;@lang('accounting.revenue.edit.page_title')
@endsection

@section('page_title_desc')
    @lang('accounting.revenue.edit.page_title_desc')
@endsection
        ...
        <form class="form-horizontal" action="{{ route('db.acc.revenue.edit', $r->hId()) }}" method="post" data-parsley-validate="parsley">
            ...
            <div class="box-body">
                ...
                <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-5">
                        <input id="inputAmount" name="amount" type="text" class="form-control" placeholder="@lang('accounting.revenue.edit.field.amount')" data-parsley-required="true">
