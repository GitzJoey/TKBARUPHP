                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group date">
                                            ...
                                            <vue-datetimepicker id="inputShippingDate" name="shipping_date" v-model="PO.po_created" v-validate="'required'" format="YYYY-MM-DD hh:mm A" readonly="true"></vue-datetimepicker>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
