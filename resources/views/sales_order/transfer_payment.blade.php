            ...
            <div class="col-md-11">
                <div class="row">
                    <div class="col-md-6">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">@lang('sales_order.payment.transfer.box.customer')</h3>
                            </div>
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputCustomerType"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.field.customer_type')</label>
                                    <div class="col-sm-5">
                                ...
                                @if($currentSo->customer_type == 'CUSTOMERTYPE.R')
                                    <div class="form-group">
                                        <label for="inputCustomerId"
                                               class="col-sm-2 control-label">@lang('sales_order.payment.transfer.field.customer_name')</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" readonly
                                ...
                                @else
                                    ...
                                    <div class="form-group">
                                        <label for="inputCustomerDetails"
                                               class="col-sm-2 control-label">@lang('sales_order.payment.transfer.field.customer_details')</label>
                                        <div class="col-sm-10">
                    ...
                    <div class="col-md-6">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">@lang('sales_order.payment.transfer.box.sales_order_detail')</h3>
                            </div>
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputSoCode"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.so_code')</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="inputSoType"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.so_type')</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" readonly
                                ...
                                <div class="form-group">
                                    <label for="inputSoDate"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.so_date')</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="inputSoStatus"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.so_status')</label>
                                    <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">@lang('sales_order.payment.transfer.box.shipping')</h3>
                            </div>
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputShippingDate"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.field.shipping_date')</label>
                                    <div class="col-sm-5">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                ...
                                <div class="form-group">
                                    <label for="inputWarehouse"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.field.warehouse')</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" readonly
                                ...
                                <div class="form-group">
                                    <label for="inputVendorTrucking"
                                           class="col-sm-2 control-label">@lang('sales_order.payment.transfer.field.vendor_trucking')</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" readonly
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">@lang('sales_order.payment.transfer.box.transactions')</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="itemsListTable" class="table table-bordered table-hover">
                                            <thead>
                                            <tr>
                                                <th width="30%">@lang('sales_order.payment.transfer.table.item.header.product_name')</th>
                                                <th width="15%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.item.header.header.quantity')</th>
                                                <th width="15%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.item.header.unit')</th>
                                                <th width="15%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.item.header.price_unit')</th>
                                                <th width="5%">&nbsp;</th>
                                                <th width="20%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.item.header.total_price')</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="itemsTotalListTable" class="table table-bordered">
                                            ...
                                            <tr>
                                                <td width="80%"
                                                    class="text-right">@lang('sales_order.payment.transfer.table.total.body.total')</td>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">@lang('sales_order.payment.transfer.box.remarks')</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">@lang('sales_order.payment.transfer.box.payment_history')</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="paymentHistoryTable" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <th width="25%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.payments.header.payment_type')</th>
                                                <th width="25%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.payments.header.payment_date')</th>
                                                <th width="25%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.payments.header.payment_status')</th>
                                                <th width="25%"
                                                    class="text-center">@lang('sales_order.payment.transfer.table.payments.header.payment_amount')</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="paymentSummaryTable" class="table table-bordered">
                                            <tbody>
                                            <tr>
                                                <td class="text-right">@lang('sales_order.payment.transfer.table.total.body.paid_amount')</td>
                                                <td width="25%" class="text-right">
                                                    <span class="control-label-normal">{{ number_format($currentSo->totalAmountPaid(), 2) }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-right">@lang('sales_order.payment.transfer.table.total.body.to_be_paid_amount')</td>
                                                <td width="25%" class="text-right">
